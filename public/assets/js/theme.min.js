!(function () {
    ...
    (function () {
        for (
            var e, t = document.getElementsByTagName("pre"), o = 0;
            o < t.length;
            o++
        )
            0 === t[o].children[0].className.indexOf("language-") &&
    ...
    $(document).ready(function () {
        var e;
        $(".menu-list").length &&
            $(".menu-list").slimScroll({ height: "100%" }),
            $(".header").length &&
                $(window).scroll(function () {
                    200 < $(".header").offset().top
            ...
            $("#pageSlide").length &&
                tns({
                    ...
                    nav: !1,
                    responsive: {
                        1400: { items: 3, fixedWidth: 500 },
                        768: { edgePadding: 15, fixedWidth: 355, items: 1 },
                        1200: { items: 3 },
                        375: { edgePadding: 15, fixedWidth: 315, items: 1 },
                    },
                }),
            $("#heroSlide").length &&
                tns({
